export const advisoryCopy = {
  en: {
    ...
    testimonials: {
      ...
      companies: ['Meridian Group', 'Vertex Capital', 'Clearfield', 'Apex Holdings', 'NovaTech'],
      items: [
        {
          quote:
            'ConsultPro compressed what would have been a three-year transformation into fourteen months. Their team operated inside ours from day one with immediate impact.',
          name: 'Richard Ashworth',
          title: 'CEO, Meridian Industrial Group',
          image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1afa1ad2d-1763301474612.png',
          alt: 'Richard Ashworth portrait',
          result: '+38% EBITDA in 14 months',
        },
        {
          quote:
    ...
    contact: {
      ...
      titleFirst: 'Your next chapter',
      titleAccent: 'starts here.',
      description:
        'We respond to all qualified inquiries within one business day. Tell us about your challenge and we will match you with the right practice lead.',
      process: [
        {
          icon: 'CalendarIcon',
          title: '30-min Discovery Call',
          desc: 'We learn about your challenge and determine if we are the right fit.',
        },
        {
          icon: 'DocumentMagnifyingGlassIcon',
          title: 'Rapid Diagnostic',
          desc: 'A structured 2-week assessment to map the opportunity and define scope.',
        },
        {
          icon: 'RocketLaunchIcon',
          title: 'Engagement Launch',
          desc: 'A dedicated team embedded in your organization, typically within 30 days.',
        },
      ],
      contacts: [
      ...
      placeholders: {
        ...
        message: 'Briefly describe the business challenge or opportunity you are facing...',
      },
      services: [
        'Enterprise Excellence (Operational & Managerial)',
  ...
  ar: {
    ...
    testimonials: {
      label: 'نتائج العملاء',
      titleFirst: 'ما الذي يحدث عندما',
      titleAccent: 'تلتقي الاستراتيجية بالتنفيذ.',
      trustLabel: 'موثوق من قادة في',
      companies: ['Meridian Group', 'Vertex Capital', 'Clearfield', 'Apex Holdings', 'NovaTech'],
      items: [
        {
          quote:
            'اختصر الفريق رحلة تحول كانت ستستغرق ثلاث سنوات إلى أربعة عشر شهرًا فقط، وعملوا من داخل فريقنا منذ اليوم الأول بأثر مباشر.',
          name: 'Richard Ashworth',
          title: 'CEO, Meridian Industrial Group',
          image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1afa1ad2d-1763301474612.png',
          alt: 'Richard Ashworth portrait',
          result: '+38% EBITDA خلال 14 شهرًا',
        },
        {
          quote:
            'النمذجة المالية التي قدموها لصفقة الاستحواذ كانت الأكثر صرامة التي رأيتها خلال 20 عامًا، وقد وافق المجلس بالإجماع.',
          name: 'Sonia Kapoor',
          title: 'CFO, Vertex Capital Partners',
          image: 'https://img.rocket.new/generatedImages/rocket_gen_img_18b824279-1767883812278.png',
          alt: 'Sonia Kapoor portrait',
          result: 'إغلاق استحواذ بقيمة 240 مليون دولار',
        },
        {
          quote:
            'جرّبنا شركتين قبلهم، لكنهم كانوا أول من فهم تعقيدنا التشغيلي فعلًا. بعد ستة أشهر خفّضنا التكاليف 19% دون أي تسريح.',
          name: 'James Okonkwo',
          title: 'COO, Clearfield Logistics',
          image: 'https://img.rocket.new/generatedImages/rocket_gen_img_197ee41e5-1774398641466.png',
          alt: 'James Okonkwo portrait',
          result: 'خفض تكاليف 19%',
        },
      ],
    },
    contact: {
      label: 'ابدأ المحادثة',
      titleFirst: 'فصلك التالي',
      titleAccent: 'يبدأ هنا.',
      description:
        'نرد على جميع الاستفسارات المؤهلة خلال يوم عمل واحد. أخبرنا عن تحديك وسنوصلك بجهة الاختصاص المناسبة.',
      process: [
        {
          icon: 'CalendarIcon',
          title: 'مكالمة استكشافية لمدة 30 دقيقة',
          desc: 'نتعرف على التحدي ونحدد ما إذا كنا الجهة المناسبة للعمل معك.',
        },
        {
          icon: 'DocumentMagnifyingGlassIcon',
          title: 'تشخيص سريع',
          desc: 'تقييم منظم لمدة أسبوعين لرسم الفرصة وتحديد نطاق العمل.',
        },
        {
          icon: 'RocketLaunchIcon',
          title: 'إطلاق التنفيذ',
          desc: 'فريق مخصص يعمل داخل مؤسستك، غالبًا خلال 30 يومًا.',
        },
      ],
      contacts: [
      ...
      submittedText: 'شكرًا لتواصلك. سيتواصل معك أحد مستشاري AMC خلال يوم عمل واحد.',
      sendAnother: 'أرسل رسالة أخرى',
      formTitle: 'نموذج الاستفسار',
      formNote: 'جميع الحقول التي تحمل * مطلوبة. نرد خلال يوم عمل واحد.',
      fields: {
        name: 'الاسم الكامل *',
        ...
        message: 'حدثنا عن التحدي الذي تواجهه *',
      },
      placeholders: {
        name: 'الاسم الكامل',
...
export function getAdvisoryCopy(locale) {
  return locale === 'ar' ? advisoryCopy.ar : advisoryCopy.en
}